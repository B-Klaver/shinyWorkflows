...
**UI:**    
This is where you define the layout and appearance of your app, including sliders, plots, tabs, etc.   

**The server:**    
This is where you connect your UI components using logic behind the scenes to drive app behaviour.
