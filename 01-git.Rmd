...
Branching is useful when you have a stable codebase that you do not want to break. You can create a branch to do development work and test new features until it's ready for integration with the stable codebase.
